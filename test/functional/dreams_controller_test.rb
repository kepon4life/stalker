...
class DreamsControllerTest < ActionController::TestCase
  ...
  test "should create dream" do
    assert_difference('Dream.count') do
      post :create, :dream => { :category_id => @dream.category_id, :file_name => @dream.file_name, :is_valid => @dream.is_valid }
    end
  ...
  test "should update dream" do
    put :update, :id => @dream, :dream => { :category_id => @dream.category_id, :file_name => @dream.file_name, :is_valid => @dream.is_valid }
    assert_redirected_to dream_path(assigns(:dream))
  end
