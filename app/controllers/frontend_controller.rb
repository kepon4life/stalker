		...
		I18n.locale = request.env['HTTP_ACCEPT_LANGUAGE'].scan(/^[a-z]{2}/).first
  		case I18n.locale
	  		when :en
	  			...
	  			@msg_description = "The new exhibition of the Maison dAilleurs, co-produced by the HEIG-VD. 15.09.2013 – 02.03.2014"
	  		else
	  			@msg_name = "Découvrez de quoi les gens rêvent"
	  			@msg_caption = "Stalker | Experimenter la Zone"
	  			@msg_description = "La nouvelle exposition de la Maison dAilleurs, co-production de la HEIG-VD. 15.09.2013 – 02.03.2014"
  		end
