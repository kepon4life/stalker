...
//    }
    ...
    var onCursorUpdate = function(cursors) {
    ...
    tuio.cursor_update(function(data) {
        onCursorUpdate(tuio.cursors);
    });
    window.onCursorUpdate = onCursorUpdate;
...
//privateChannel.bind('pusher:subscription_succeeded', function() {
    $('body').on('click', '#envoyer', sendTosave);
    $('body').on('click', '#effacer', clear);
